...
## NOTICE
# This was pulled in from upstream to add/fix docker support. It can be
# removed when we're using an ansible with the upstream fixes included,
# which will likely be 2.3.0.0.
# https://github.com/ansible/ansible/issues/18706
# https://github.com/ansible/ansible/issues/16306
# https://github.com/ansible/ansible/issues/20117
